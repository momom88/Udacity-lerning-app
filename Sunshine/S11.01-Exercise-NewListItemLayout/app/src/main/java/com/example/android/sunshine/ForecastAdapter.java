...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        /* Use the weatherId to get small art resource id*/
        ...
        forecastAdapterViewHolder.textViewWeather.setText(description);
        forecastAdapterViewHolder.textViewMinTemp.setText(lowTemperature);
        forecastAdapterViewHolder.textViewMaxTemp.setText(highTemperature);
...
//          TODO (6) Get references to all new views and delete this line
            ...
            imageViewWeatherIcon = (ImageView) view.findViewById(R.id.imageView);
